...
brew install tree git terraform tflint wget mongosh helm htop mtr jq hidetatz/tap/kubecolor k9s gcloud warrensbox/tap/tfswitch
...
PATH=~/Users/juliendacunha/bin:$PATH